...
// TODO: Move to AI types
export type ToolKeys = "search" | "research" | "deepSearch";
  ...
  return create<ThreadStoreImpl<UI_MESSAGE>>()(
    devtools(
      subscribeWithSelector((set, get) => {
        ...
        const throttledSetMessages = throttle(setMessages, THROTTLE_TIME);
        ...
        return {
          ...
          setTool: (tool: ToolKeys | "") =>
            set({ tool }, false, "thread/setTool"),
