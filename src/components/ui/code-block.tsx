/** biome-ignore-all lint/security/noDangerouslySetInnerHtml: we are using dangerouslySetInnerHTML to render the code */
...
function CodeBlockCode({
  ...
  function handleCopy() {
    ...
    navigator.clipboard.writeText(code).then(() => {
      setIsCopied(true);
      setTimeout(() => setIsCopied(false), COPIED_DELAY);
    });
  }
