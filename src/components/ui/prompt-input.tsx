/** biome-ignore-all lint/correctness/useExhaustiveDependencies: we don't want tore-run this effect */
...
const PromptInputContext = createContext<PromptInputContextType>({
  isLoading: false,
  value: "",
  // biome-ignore lint/suspicious/noEmptyBlockStatements: we don't want to set the value
  setValue: () => {},
  maxHeight: 240,
  onSubmit: undefined,
  disabled: false,
