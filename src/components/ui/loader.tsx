...
export function DotsLoader({
  ...
  const dotsLoaderKeys = ["dots-loader-0", "dots-loader-1", "dots-loader-2"];
...
export function BarsLoader({
  ...
  const barsLoaderKeys = ["bars-loader-0", "bars-loader-1", "bars-loader-2"];
