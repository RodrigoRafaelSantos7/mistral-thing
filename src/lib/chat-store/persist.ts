...
// biome-ignore lint/suspicious/noExplicitAny: we need to use any here because idb-keyval is not typed
const stores: Record<string, any> = {};

const isClient = typeof window !== "undefined";
const DB_NAME = "mistral-thing-db";
const DB_VERSION = 2;
        ...
        if (objectStores.length === 0) {
          ...
          deleteRequest.onsuccess = () => {
            ...
            dbInitPromise.then(() => {
              ...
              // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: we need to handle the success and error cases
